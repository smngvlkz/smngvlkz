...
[![My Skills](https://skillicons.dev/icons?i=bash,c,js,ts,cs,py,css,html,react,tailwind,git,github,linux,vim,angular,nextjs,nodejs,mongodb,mysql,prisma,vercel,visualstudio,vscode,vite&perline=1)](https://skillicons.dev)
